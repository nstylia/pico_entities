#file sources from https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/seq2seq/python/ops/attention_wrapper.py
...
class _BaseAttentionMechanismV2(AttentionMechanism, layers.Layer):
    ...
    def deserialize_inner_layer_from_config(cls, config, custom_objects):
        ...
        from tensorflow.python.keras.layers import \
            deserialize as deserialize_layer  # pylint: disable=g-import-not-at-top

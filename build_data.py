...
from src.data_utils import CoNLLDataset, get_vocabs, UNK, NUM, PAD_TOKEN, PAD_CHAR, \
    ELMo_Start, ELMo_End, get_glove_vocab, write_vocab, load_vocab, get_char_vocab, \
    export_trimmed_glove_vectors, get_processing_word, \
    get_processing_word_elmo
import os, sys
from glob import glob
from collections import defaultdict


def generate_model_data_elmo(data_prefix = None):
    ...
    print('Config')
    processing_word_elmo = get_processing_word_elmo(lowercase=False)
    print('processing_word_elmo')
    ...
    dev = CoNLLDataset(config.filename_dev, processing_word_elmo)
    test = CoNLLDataset(config.filename_test, processing_word_elmo)
    train = CoNLLDataset(config.filename_train, processing_word_elmo)
...
if __name__ == "__main__":
  ...
  generate_model_data_elmo(data_prefix)
